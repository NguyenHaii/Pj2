...
public class LayoutController {
    ...
    @FXML
    public Button dashboardButton, computerButton, customersButton, reportsButton, foodButton, logoutButton;

    private List<Button> menuButtons;

    @FXML
    public void initialize() {
        menuButtons = List.of(dashboardButton, computerButton, customersButton, reportsButton,foodButton);
